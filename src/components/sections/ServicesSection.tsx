  ...
  const services = [
    {
      ...
      description:
        "We bridge individuals and communities to generate and transfer value by developing platforms.",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "We research innovations, carry out analytics and design sustainable diffusion mechanisms to empower builders.",
    },
  ];
