  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <div
          ref={ref}
          className="text-left hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
        >
              ...
              <div className="flex-1 p-4 ">
                <div className="flex w-full flex-wrap gap-1  ">
                  {post.category.map((data) => {
                    return (
                      <span className=" bg-slate-400 text-white px-2 py-1 m-1 rounded-full text-[12px] font-medium">
                        {data}
                      </span>
                    );
                  })}
