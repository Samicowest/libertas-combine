...
const ServicesSection = () => {
  const services = [
    {
      ...
      description:
        "We provide institutional and individual investors superior transparency and accessibility.",
    },
    {
      icon: Users,
      title: "PERSONNEL DEVELOPMENT AND TRAINING",
      description:
        "We improve recruiting and social in a way that enhances your company's human capabilities.",
    },
    {
      icon: BarChart3,
      title: "FINANCIAL ANALYTICS AND SOFTWARE",
      description:
        "We deliver informational services for financial markets, efficient prediction and analytics.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-20 left-10 w-16 h-16 bg-blue-100 rounded-full opacity-30 animate-bounce"
