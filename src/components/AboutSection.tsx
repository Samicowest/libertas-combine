      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          <div className="space-y-6 lg:space-y-8">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">About Us</h2>
              ...
              <div className="bg-white p-4 sm:p-6 rounded-lg">
                <div className="w-full h-64 sm:h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                  <div className="text-center">
                    <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-br from-[#1a1b3a] to-[#2d1b69] rounded-lg mx-auto mb-4 flex items-center justify-center">
